...
@app.route('/api/users/<user_id>/analysis', methods=['GET'])
def get_user_analysis(user_id):
    ...
    client.db.users.update_one({'_id': ObjectId(user_id)}, {'$push': {'recommended_films': json.loads(response_gpt)['recommendations']}})
